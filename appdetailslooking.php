        ...
        <head>
            ...
            <style>
                ...
                .container {
                    ...
                    margin-left: 90px;
                    display: flex;
                    flex-direction: column; /* Ensures boxes are stacked vertically */
                    gap: 20px;
                }
                .job-header {
                    display: flex;
    ...
    <section>
            <div class="container">
                ...
                <div class="job-details1">
                    <p><strong>Eligible Courses : </strong><br><?php echo nl2br(htmlspecialchars($job['courses'])); ?></p>
                </div><br>
                ...
                <div class="job-details2">
                    <p><strong>Eligible Criteria : </strong><br> <?php echo nl2br(htmlspecialchars($job['criteria'])); ?></p>
                </div><br>
