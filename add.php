...
if (isset($_POST['add_question'])) {
    ...
    $sql = "INSERT INTO questions (course_id, question, option1, option2, option3, option4, correct_option) 
            VALUES ('$course_id', '$question', '$option1', '$option2', '$option3', '$option4', '$correct_option')";
...
<head>
    ...
    <style>
        ...
        .settings-form .pro2 .pro textarea{
            width: 70%;
            height: 40px;
            border: 2px solid rgba(255, 255, 255, .2);
            border-radius: 40px;
...
<div class="header">
    ...
    <form method="post">
        ...
        <button type="submit" class="btn" name="add_question">Add Question</button>
    </form>
    </div> </div>
    </div> 
    </div>
