...
#hero .home {
    ...
    justify-content: flex-start; /* Push items to the top of the container */
}

#hero .home h1 {
    margin-top: -60px; /* Remove unnecessary top margin */
    margin-left: 400px;
    font-weight: 800;
    font-size: 68px;
    color: black;
...
#hero .register {
  ...
  flex-direction: column; /* Arrange items vertically */
  align-items: flex-start; /* Align items to the start (left side) */
  gap: 10px; /* Optional: Add spacing between the input and button */
  width: 100%; /* Ensure they align properly */
}
...
<section id="header">
        ...
        <div>
            <ul id="navbar">
                ...
                <li><a href="course.php">Assignment</a></li>
                <li><a href="emp_profile.php"><img src="image/pro.png"></a></li>
    ...
    <section id="hero">
        ...
        <h3>Empowering you to Build up Opportunities</h3>
        </div>
    <div class="register-container">
    
    <form class="" action="" method="POST">
    <div class="register">
            <input type="text" class="pro4" name="jobname"  placeholder="Job category or keyword"></textarea><br>
