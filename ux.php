...
$jobname="";
$salary="";
$query = "SELECT * FROM jobhiring WHERE jobname='ux/ui developer';";
?>
        ...
        if (mysqli_num_rows($query_row) > 0) {
            while ($res = mysqli_fetch_assoc($query_row)) {
                ...
                <div class="job-card">
                    ...
                    <h3>
                        <a href="uxdetails.php?job_id=<?php echo htmlspecialchars($res['id']); ?>" 
                           style="text-decoration: none; color: inherit;">
                           <?php echo htmlspecialchars($res['jobname']); ?>
                        </a>
                    </h3>
                    <h3><?php echo htmlspecialchars($res['jobname']); ?></h3>
