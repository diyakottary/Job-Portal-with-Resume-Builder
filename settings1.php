...
<body>
    ...
    <div class="header">
        <div class="side-nav">
            ...
            <ul class="nav-links">
                <li><a href="settings1.php"><i class='bx bxs-user-account'></i><p>Account Settings</p></a></li>
                <li><a href="privacy1.php"><i class='bx bx-shield-quarter'></i><p>Privacy & Security</p></a></li>
